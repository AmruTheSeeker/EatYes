    ...
    return (
      <div>
        <div>
          ...
          >
            <p className="text-center font-bold text-secondary-200">BMI</p>
          </button>
        </div>
        ...
        <BarChart width={380} height={70} data={data} layout="vertical">
          ...
          <Bar dataKey="Normal Weight (18.5 - 25)" stackId="a" fill="#67C740" />
        ...
        <div className="flex mt-[-10px]">
          ...
          <div className="absolute w-[180px] text-center text-[9px] ml-[198px]">
            <div className="bg-[#F95F62] text-white">Over Weight (25 - 30)</div>
